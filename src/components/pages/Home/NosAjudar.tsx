...
export function NosAjudar() {
  return (
    <section>
      <div className="flex max-w-[1312px] mx-auto px-4 py-20 border mt-20 border-b-0 border-x-0 border-t-gray-400">
        <Image src={Dogs} alt="" />

        <div className="text-center">
          <span className="font-semibold text-light-text mb-4 block">Você pode nos ajudar!</span>
          <h2 className={`${myFont.className} text-dark-blue text-3xl px-6`}>

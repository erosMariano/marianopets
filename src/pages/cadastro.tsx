  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content={`Mariano Pets - Cadastro`} />
        ...
        <meta property="og:url" content={`https://marianopets.vercel.app/cadastro`} />
      ...
      <main className="max-w-[1312px] mx-auto px-4 mt-20 pb-20 w-full">
        <div className="bg-white w-full rounded-2xl shadow-sm flex lg:flex-row overflow-hidden">
          ...
          <div className="w-full lg:w-[27rem] mx-auto px-4 py-10 lg:px-0 lg:py-20 justify-center flex flex-col">
            <h1
